...
export function log(message, doc) {
  const logBox = doc.getElementById('logs') || doc.getElementById('status');
  if (!logBox || message === oldLog) {
    return;
  }
  oldLog = message;
